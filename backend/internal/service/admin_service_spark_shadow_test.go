...
func TestCreateShadow(t *testing.T) {
	...
	require.Equal(t, true, shadow.Extra["codex_cli_only"])
	require.Equal(t, true, shadow.Extra["codex_cli_only_allow_app_server"])
	require.Equal(t, string(codexFingerprintSession), shadow.Extra[codexFingerprintModeExtraKey])
