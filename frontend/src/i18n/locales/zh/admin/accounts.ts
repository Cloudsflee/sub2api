export default {
    accounts: {
      ...
      toolActions: '工具',
      openAI5hWake: {
        title: '唤醒 OpenAI 5h 窗口',
        action: '唤醒 OpenAI 5h 窗口',
        runningEntry: '5h 唤醒 {processed}/{total}',
        loading: '正在检查账号与后台任务...',
        scopeNotice: '本操作固定处理数据库内全部可调度的 OpenAI OAuth global 账号，不受当前筛选或勾选影响。',
        usageNotice: '唤醒会向 OpenAI 发送最小真实请求，因此可能产生少量上游用量。已有活跃 5h 窗口会直接跳过。',
        eligibleAccounts: '符合条件账号',
        uniqueQuotaPools: '唯一额度池',
        activeWindows: '已活跃跳过',
        estimatedRequests: '预计请求数',
        totalOpenAIAccounts: 'OpenAI 账号总数',
        excludedAccounts: '排除账号数',
        exclusionDetails: '查看排除原因',
        noEligiblePools: '当前没有可处理的 OpenAI OAuth global 额度池。',
        confirmStart: '确认并启动',
        newTask: '启动新任务',
        starting: '正在启动...',
        taskLabel: '后台任务 #{id}',
        backgroundHint: '任务由后台持续执行，关闭弹窗或离开页面不会终止任务。',
        progress: '处理进度',
        lastActivity: '最后执行事件',
        runningPools: '正在处理的额度池',
        woken: '已唤醒',
        skipped: '已跳过',
        failed: '失败',
        cancelled: '已取消',
        earliestReset: '最早重置时间',
        latestReset: '最晚重置时间',
        alignmentSpan: '窗口对齐跨度',
        executionLog: '执行日志',
        logCount: '共 {count} 条',
        loadingLogs: '正在加载执行日志...',
        noLogs: '暂无执行日志',
        results: '额度池结果',
        pool: '额度池哈希',
        members: '成员账号 ID',
        ...
        cancelTask: '取消任务',
        cancelling: '正在取消...',
        cancelRequested: '已请求取消，正在停止在途请求',
        cancelConfirmTitle: '取消唤醒任务',
        cancelConfirmMessage: '确定取消此后台任务？已完成的额度池不会回滚。',
        loadFailed: '加载 OpenAI 5h 唤醒信息失败',
        startFailed: '启动 OpenAI 5h 唤醒任务失败',
        refreshFailed: '刷新 OpenAI 5h 唤醒任务失败',
        resultsLoadFailed: '加载额度池结果失败',
        cancelFailed: '取消 OpenAI 5h 唤醒任务失败',
        completed: 'OpenAI 5h 唤醒完成：唤醒 {woken}，跳过 {skipped}，失败 {failed}',
        completedWithFailures: 'OpenAI 5h 唤醒已结束：唤醒 {woken}，跳过 {skipped}，失败 {failed}',
        status: {
          pending: '等待执行',
          running: '执行中',
          succeeded: '已完成',
        ...
        events: {
          ...
          task_resume_failed: '恢复任务失败',
          cancel_requested: '已请求取消',
          cancel_observed: 'Worker 已收到取消请求',
          cancel_check_failed: '检查取消状态失败',
          cancel_poll_failed: '轮询取消状态失败',
          final_cancel_check_failed: '最终取消检查失败',
          item_started: '开始处理额度池',
          account_attempt_started: '开始尝试账号',
          account_attempt_failed: '账号尝试失败',
          usage_check_failed: '额度检查失败',
          wake_request_started: '正在发送唤醒请求',
          wake_request_failed: '唤醒请求失败',
          wake_request_accepted: '唤醒请求已被上游接受',
          wake_request_succeeded: '5h 窗口已确认生效',
          wake_confirmation_pending: '等待 5h 窗口生效',
          item_woken: '额度池窗口已唤醒',
          ...
          empty_task: '任务不包含可执行额度池',
          heartbeat_failed: '任务心跳失败',
          lease_lost: '任务执行租约已丢失',
          task_processing_failed: '任务执行中断',
          task_finalize_failed: '任务收尾失败',
          task_finished: '任务已结束'
        },
        exclusions: {
          api_key: 'API Key 账号',
          non_oauth: '非 OAuth 账号',
          spark_shadow: 'Spark 影子账号',
          non_global: '非 global 额度维度',
          no_5h_entitlement: '无 5h 额度资格',
          disabled: '账号已禁用',
          unschedulable: '未参与调度',
          expired: '账号已过期',
          rate_limited: '账号处于限流',
          cooling_down: '账号处于冷却',
          missing_identity: '缺少上游身份'
        }
      },
      viewColumns: '列显示',
      ...
      rateLimited: '限流中',
      usageError: '获取失败',
      usageRefreshFailed: '刷新用量失败',
      usageRefreshFailedStale: '刷新失败，当前显示的是上次成功的数据',
      testing: '测试中...',
