export default {
  ...
  version: {
    ...
    syncToFork: '同步到我的仓库',
    updating: '正在更新...',
    updateQueued: '仓库更新已排队',
    updateQueuedHint: '{version} 将先同步到你的仓库，通过 CI 后自动部署',
    updateSyncing: '正在同步官方更新',
    updateSyncingHint: '正在将 {version} 合并到你的 custom 分支',
    updateWaitingForCI: '已推送，等待 CI',
    updateWaitingForCIHint: '{version} 已进入你的仓库，CI 全绿后才会部署',
    updateWaitingForDeploy: 'CI 已接管更新',
    updateWaitingForDeployHint: '{version} 已在 custom 分支中，等待批准分支和服务器部署',
    updateComplete: '更新完成',
    updateFailed: '更新失败',
    ...
    rollbackManagedHint: '托管构建使用服务器保留的不可变镜像回退，不会下载官方二进制',
    deployScript: '脚本部署',
    deployDocker: 'Docker',
