export default {
  ...
  version: {
    ...
    syncToFork: 'Sync to My Fork',
    updating: 'Updating...',
    updateQueued: 'Repository update queued',
    updateQueuedHint: '{version} will sync to your fork and deploy only after CI passes',
    updateSyncing: 'Syncing official update',
    updateSyncingHint: 'Merging {version} into your custom branch',
    updateWaitingForCI: 'Pushed, waiting for CI',
    updateWaitingForCIHint: '{version} is in your fork and will deploy only after CI passes',
    updateWaitingForDeploy: 'CI is processing the update',
    updateWaitingForDeployHint: '{version} is in custom and is waiting for approval and server deployment',
    ...
    rollbackManagedHint: 'Managed builds roll back with retained server images and never download an official binary',
    deployScript: 'Script',
    deployDocker: 'Docker',
