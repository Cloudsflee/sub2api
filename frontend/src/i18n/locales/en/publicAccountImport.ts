export default {
  publicAccountImport: {
    ...
    productsHint: 'Out-of-stock products are hidden and prices are sorted high to low',
    syncProducts: 'Sync now',
    syncingProducts: 'Syncing',
    ...
    productsSyncQueued: 'Queued {count} shops for synchronization',
    productsSyncAlreadyRunning: 'The product catalog is already syncing in the background',
    productsSyncRecent: 'A sync was requested recently. Try again in {seconds} seconds',
    productsSyncComplete: 'Product catalog synchronization completed',
    productsSyncIncomplete: 'Product catalog sync ended with {count} shops incomplete',
    productsSyncUpToDate: 'There are no product shops to synchronize',
    productsSyncFailed: 'Failed to request product catalog synchronization',
