export default {
  publicAccountImport: {
    ...
    subtitle: 'Upload Codex account JSON files. Accounts join the selected groups and ALL automatically. Scheduling priority: OTHER = 1, FREE = 3, all other groups = 2; default concurrency = 3.',
