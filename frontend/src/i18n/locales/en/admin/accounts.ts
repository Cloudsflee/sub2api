export default {
    accounts: {
      ...
      toolActions: 'Tools',
      openAI5hWake: {
        title: 'Wake OpenAI 5h Windows',
        action: 'Wake OpenAI 5h Windows',
        runningEntry: '5h wake {processed}/{total}',
        loading: 'Checking accounts and background tasks...',
        scopeNotice: 'This operation always covers every schedulable OpenAI OAuth global account in the database. Current filters and selections do not affect it.',
        usageNotice: 'Waking sends a minimal real request to OpenAI and may consume a small amount of upstream usage. Active 5h windows are skipped.',
        eligibleAccounts: 'Eligible accounts',
        uniqueQuotaPools: 'Unique quota pools',
        activeWindows: 'Active windows skipped',
        estimatedRequests: 'Estimated requests',
        totalOpenAIAccounts: 'Total OpenAI accounts',
        excludedAccounts: 'Excluded accounts',
        exclusionDetails: 'View exclusion reasons',
        noEligiblePools: 'There are no eligible OpenAI OAuth global quota pools.',
        confirmStart: 'Confirm and start',
        newTask: 'Start new task',
        starting: 'Starting...',
        taskLabel: 'Background task #{id}',
        backgroundHint: 'The task continues in the background when this dialog is closed or the page is left.',
        progress: 'Progress',
        lastActivity: 'Last execution event',
        runningPools: 'Quota pools in progress',
        woken: 'Woken',
        skipped: 'Skipped',
        failed: 'Failed',
        cancelled: 'Cancelled',
        ...
        alignmentSpan: 'Window alignment span',
        executionLog: 'Execution log',
        logCount: '{count} events',
        loadingLogs: 'Loading execution log...',
        noLogs: 'No execution events yet',
        results: 'Quota pool results',
        pool: 'Quota pool hash',
        members: 'Member account IDs',
        itemStatus: 'Status',
        attempts: 'Execution attempts',
        resetAt: '5h reset time',
        errorCode: 'Error code',
        loadingResults: 'Loading results...',
        noResults: 'No task items yet',
        cancelTask: 'Cancel task',
        cancelling: 'Cancelling...',
        cancelRequested: 'Cancellation requested; stopping in-flight requests',
        cancelConfirmTitle: 'Cancel wake task',
        cancelConfirmMessage: 'Cancel this background task? Completed quota pools will not be rolled back.',
        loadFailed: 'Failed to load OpenAI 5h wake information',
        startFailed: 'Failed to start the OpenAI 5h wake task',
        refreshFailed: 'Failed to refresh the OpenAI 5h wake task',
        resultsLoadFailed: 'Failed to load quota pool results',
        cancelFailed: 'Failed to cancel the OpenAI 5h wake task',
        completed: 'OpenAI 5h wake completed: {woken} woken, {skipped} skipped, {failed} failed',
        completedWithFailures: 'OpenAI 5h wake finished: {woken} woken, {skipped} skipped, {failed} failed',
        status: {
          pending: 'Pending',
          running: 'Running',
          succeeded: 'Completed',
        ...
        events: {
          ...
          task_resume_failed: 'Task recovery failed',
          cancel_requested: 'Cancellation requested',
          cancel_observed: 'Worker observed cancellation',
          cancel_check_failed: 'Cancellation check failed',
          ...
          task_finalize_failed: 'Task finalization failed',
          task_finished: 'Task finished'
        },
        exclusions: {
          api_key: 'API Key account',
          ...
          missing_identity: 'Missing upstream identity'
        }
      },
      viewColumns: 'Columns',
